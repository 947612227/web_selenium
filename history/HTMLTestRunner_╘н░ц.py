...
class Template_mixin(object):
    ...
    DEFAULT_DESCRIPTION = 'Selenium HTMLTestRunner testReport'
...
<a class="btn btn-primary" href='javascript:showCase(0)'>展示</a>
<a class="btn btn-primary" href='javascript:showCase(1)'>摘要</a>
<a class="btn btn-primary"  href='javascript:showCase(2)'>失败</a>
<a class="btn btn-primary"  href='javascript:showCase(3)'>全部</a>
</p>
...
class HTMLTestRunner(Template_mixin):
    ...
    def run(self, test):
        ...
        print(sys.stderr)
        print('共计耗时: %s' % (self.stopTime-self.startTime))
        return result
